function File = func_FileSetup_exec(startCommands,endCommands,Mode,Category,Geometry,Diameter,Layers,Tail,Speed,amp,pha,Correction,Resolution, ...
                Length,Width,p,q,K,P,A,B,ucP,ucQ)
